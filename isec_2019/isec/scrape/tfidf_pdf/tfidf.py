...
arr = ['bhc.txt', 'IPOL_BRI(2018)614491_EN.txt', 'Reserve Bank of India - Master Circulars.txt', 'npl_guidance.en.txt', 'non-performing-loans-regulatory-and-accounting-treatments-of-assets.txt']
for i in arr:
